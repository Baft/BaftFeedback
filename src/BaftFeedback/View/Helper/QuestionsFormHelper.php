...
class QuestionsFormHelper extends AbstractHelper implements ServiceLocatorAwareInterface {
	...
	public function __invoke($submission = null, $options = []) {
	...
	public function getForm() {
		...
		// @todo read feeedback and submission from arguments or from questionsForm by formElementManager
		$submission = $this->getSubmission ();
		
		$feedback = $submission->getRefBaftfeedbackFeedback ();
		
		$form = $feedbackService->getQuestionsForm ( $feedback, $submission );
