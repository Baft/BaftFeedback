...
class BaftfeedbackFeedback implements BaftFeedbackEntityInterface {
	...
	/**
	 *
	 * @var \BaftFeedback\Entity\BaftfeedbackQuestionGroup $refBaftfeedbackQuestionGroupId
	 *
	 * @ORM\OneToOne(targetEntity="BaftFeedback\Entity\BaftfeedbackQuestionGroup" )
	 ...
	 *      "find_method" : {
	 *      "name" : "findBy",
	 *      "params" : {"criteria" : {"refGroupParent" : null}}
	 *      },
