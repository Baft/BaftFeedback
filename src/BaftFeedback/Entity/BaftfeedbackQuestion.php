 ...
 *
 * @ORM\Table(name="baftfeedback_question", indexes={@ORM\Index(name="fk_baftfeedback_question_baftfeedback_question_structure1_idx", columns={"ref_baftfeedback_question_structure_id"})})
