...
class BaftfeedbackFeedbackSubmissionData implements BaftFeedbackEntityInterface {
	 ...
	 * @ORM\ManyToOne(targetEntity="BaftFeedback\Entity\BaftfeedbackFeedbackSubmission" )
	 *      @ORM\JoinColumns({
	...
	/**
	 *
	 * @var integer @ORM\Column(name="version", type="integer", nullable=true)
	 */
	private $version;
	...
	/**
	 * @return the $refBaftfeedbackFeedbackSubmissionId
	 */
	...
	/**
	 * @param \BaftFeedback\Entity\BaftfeedbackFeedbackSubmission $refBaftfeedbackFeedbackSubmissionId
	 */
	public function setRefBaftfeedbackFeedbackSubmissionId($refBaftfeedbackFeedbackSubmissionId) {

		$this->refBaftfeedbackFeedbackSubmissionId = $refBaftfeedbackFeedbackSubmissionId;
		return $this;
	}
